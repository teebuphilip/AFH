...
AFH v1.3 — Verdict Routing (FIXED)
----------------------------------
...
#
# Original conservative thresholds: OVERLAY_KEEP=80, ARR_KEEP=90
# Current relaxed thresholds: OVERLAY_KEEP=65, ARR_KEEP=70

OVERLAY_KEEP_THRESHOLD = 50  # Original: 80, TODO: raise to 65 after fixing scoring
OVERLAY_HOLD_THRESHOLD = 40  # Original: 65

ARR_KEEP_THRESHOLD = 55  # Original: 90, TODO: raise to 70 after fixing scoring
ARR_HOLD_THRESHOLD = 45  # Original: 70
